...
namespace HundensVagga {
    internal class FadeInBox {
        ...
        internal FadeInBox(double time) {
            elapsedTime = 0;
            boxTransparency = MAX_BOX_TRANSPARENCY;
        ...
        private void Advance() {
            boxTransparency = Math.Max(boxTransparency - boxTransparencyStep, MIN_BOX_TRANSPARENCY);
        }
        ...
        public bool IsDone() {
            return boxTransparency == MIN_BOX_TRANSPARENCY;
        }
    }
}
